<?php
    ...
    /**
     * Classe TraitementMotDePasseOublie
     */
    class TraitementMotDePasseOublie
    {
        ...
        /**
         * @var TexteMotDePasseOublie texte
         */
        private TexteMotDePasseOublie $texte;
        ...
        public function __construct(Render $rendu)
        {
            ...
            global $config;
            $this->config = $config;
            $this->texte = new TexteMotDePasseOublie($this->config);
        }
