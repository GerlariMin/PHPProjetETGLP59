...
class RequetesInscription extends Model {
     ...
     * @return bool
     */
    public function insererUtilisateur(String $identifiant, String $nom, String $prenom, String $login, String $email, String $password, int $aboUser = 1): bool
    {
        ...
        $sql = "INSERT INTO utilisateurs (identifiantUtilisateur, nomUtilisateur, prenomUtilisateur, loginUtilisateur, emailUtilisateur, abonnementUtilisateur, motDePasseChiffreUtilisateur, motDePasseOublie) VALUES (:identifiant, :nom, :prenom, :login, :email, :abonnement, :motDePasse, FALSE)";
        ...
        $this->logs->messageLog('Paramètres: [identifiant: ' . $identifiant . ', login: ' . $login . '].', $this->logs->typeDebug);
